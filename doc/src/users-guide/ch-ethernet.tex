...
% TODO to rename: med `grep -REl 'Eth[^e]' --include '*.ned'`
...
% FIXME remove frameBursting from NED def, or fix it to false currently setting it to 'true' has no effect
